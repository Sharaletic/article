...
class _StandardUiTextFieldStyle extends UiTextFieldStyle {
  ...
  TextStyle? get counterStyle =>
      typography.labelSmall.copyWith(color: palette.foreground);
  ...
  TextStyle? get hintStyle => WidgetStateTextStyle.resolveWith((states) {
    if (states.contains(WidgetState.disabled)) {
      return typography.bodyMedium.copyWith(color: palette.secondaryForeground);
    }
    return typography.bodyMedium.copyWith(color: palette.secondaryForeground);
  });
  ...
  TextStyle? get helperStyle =>
      typography.bodySmall.copyWith(color: palette.foreground);
  ...
  InputBorder? get errorBorder => OutlineInputBorder(
    borderRadius: BorderRadius.circular(12),
    borderSide: BorderSide(color: palette.destructiveBorder),
  );
